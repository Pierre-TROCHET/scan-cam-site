...
module.exports = {
  ...
  accueil: {
    ...
    pro: {
      ...
      note: '文字识别在手机上运行，无需联网：可识别拉丁字母、日文、中文和韩文。',
    },
  ...
  assistance: {
    ...
    faq: [
      ...
      },
      {
        q: '文字识别需要联网吗？',
        r: [
          '不需要。文字由您的 iPhone 自己读取，无需连接网络，文档的内容也绝不会发送给外部服务。可识别拉丁字母、日文、中文和韩文。',
        ],
      },
      {
        q: '应用支持哪些语言？',
        r: ['法语、英语、西班牙语、德语、意大利语、葡萄牙语（巴西）、日语、中文和韩语。语言可以在应用的设置里切换。'],
      },
      {
        q: '我不小心删除了一个文档。',
        r: [
